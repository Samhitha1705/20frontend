...
const LeaveSheet = () => {
 ...
 const fetchLeaveSheet =  async () => {
  try{
    ...
    const response = await axios.get("https://webresource19.azurewebsites.net/api/getSheets", {
        method:'GET',
        headers:{
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(isSubmitted && leaveId){
        const response =  await axios.put(`https://webresource19.azurewebsites.net/api/updateSheet/${leaveId}`, leaveData, {
        ...
        setIsSubmitted(true); // Ensure it remains submitted
          ...
          const response = await axios.post(
            "https://webresource19.azurewebsites.net/api/submitSheet",
            leaveData, {
